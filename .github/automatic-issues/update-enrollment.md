The OTTR Quarto template: https://github.com/ottrproject/OTTR_Quarto is always a work in progress. We are working on adding more features and smoothing out bugs as we go. 

If you want to receive updates from the template to your quarto course, you will need to enroll this repository to the template updates by adding it to the `sync.yml` file.

# Step 1: Enroll your repository in template updates

## Option A: Open an issue in the OTTR Quarto Template Repository

- [ ] [Open an issue in the OTTR_Quarto Repo, providing the URL of the new repository](https://github.com/ottrproject/OTTR_Quarto/issues/new?assignees=kweav,carriewright11&labels=&projects=&template=new-course-add-to-sync.md&title=)

## Option B: Fork the template repository and edit the sync file to open a Pull Request

- [ ] Navigate to the [OTTR_Quarto sync file](https://github.com/ottrproject/OTTR_Quarto/blob/main/.github/sync.yml)
