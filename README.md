...
- Have [GitHub Actions robots](https://www.ottrproject.org/customize-robots.html) do repetitive tasks like spell checking and re-rendering.
...
- Check out the [rendered version of the template](https://ottrproject.org/OTTR_Quarto/).
